<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Archived_Staff.aspx.cs" Inherits="Shoe_Traders1.Archived_Staff" %>
...
<body>
  ...
  <tr>
    ...
    <td class="tg-yw4l">Kieran</td>
    <td class="tg-yw4l">Stockdale</td>
    <td class="tg-yw4l">Stock Management</td>
    <td class="tg-yw4l">Flat 10 Deacon House, Deacon Street</td>
    <td class="tg-yw4l">LE2EF</td>
    <td class="tg-yw4l">Leicestershire</td>
    <td class="tg-yw4l">07493989219</td>
    <td class="tg-yw4l">223456789</td>
    <td class="tg-yw4l">ALL</td>
    <td class="tg-yw4l">No</td>
    <td class="tg-yw4l"><a href="">Edit</a></td>
  </tr>
            </table>
     </form>
</body>
